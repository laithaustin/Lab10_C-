...
typedef void (*functions)(Sprite *balls, Sprite &reflector, Sprite &enemy, Sprite &ball, bool *revMode, bool *noColMode);
class powerups{
  ...
  powerups(Sprite *balls, Sprite &reflector, Sprite &enemy, Sprite &ball, bool *revMode, bool *noColMode);
